...
import ai.benshi.test.adapter.MergedState.NOT_LOADING
import ai.benshi.test.adapter.MergedState.REMOTE_STARTED
import ai.benshi.test.adapter.MergedState.REMOTE_ERROR
import ai.benshi.test.adapter.MergedState.SOURCE_ERROR
import ai.benshi.test.adapter.MergedState.SOURCE_LOADING
